...
IlluCon <- read_csv("C:/Users/16502/Desktop/yousif2019/Replication project_ Illusion of consensus_October 28, 2019_15.44.csv")
...
#t test comparisons for all the variables in the experimental conditions
t.test(IlluCon_light_summary$Rating_1[IlluCon_light_summary$ExpCondition1 == "TrueConsensus"], IlluCon_light_summary$Rating_1[IlluCon_light_summary$ExpCondition1 == "FalseConsensus"])

t.test(IlluCon_light_summary$Rating_1[IlluCon_light_summary$ExpCondition1 == "FalseConsensus"], IlluCon_light_summary$Rating_1[IlluCon_light_summary$ExpCondition1 == "NoConsensus"])

t.test(IlluCon_light_summary$Rating_1[IlluCon_light_summary$ExpCondition1 == "TrueConsensus"], IlluCon_light_summary$Rating_1[IlluCon_light_summary$ExpCondition1 == "NoConsensus"])
