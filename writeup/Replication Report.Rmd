...
IlluCon <- read_csv("C:/Users/16502/OneDrive/Desktop/PSYCH 251/PROJECT FILES/Replication project_ Illusion of consensus_December 6, 2019_12.25.csv")
...
t.test(Rating_1 ~ ExpCondition1, data = IlluCon_light_summary)


Illusion_summary1 <- IlluCon_light_summary %>% # the names of the new data frame and the data frame to be summarised
